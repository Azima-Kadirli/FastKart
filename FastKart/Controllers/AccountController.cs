...
{
    public class AccountController(UserManager<AppUser> _userManager, SignInManager<AppUser> _signManager,RoleManager<IdentityRole>_roleManager,IEmailService _service) : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterVM vm)
        {
            ...
            TempData["SuccessMessage"] = "Registerden ugurla kecdiniz, indi zehmet olmasa email confirmation edin.";
        ...
        public async Task<IActionResult> Login(LoginVM vm)
        {
            ...
            {
                ModelState.AddModelError("", "Zehmet olmasa email confirmation edin.");
                await SendConfirmationEmail(existUser);
                return View(vm);
            }
